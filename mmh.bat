...
echo ==========================
echo.
echo    LumberWorker : "I have a quest for you adventurer! Please kill 4 goblins in the Questing forest and return to me for a reward, they have been lurking in the woods. So much so that the lumberers 'round here cant go chop wood."
echo.
echo.
set gotquest=true
pause
...
echo ==========================
echo.
echo    WhichDocter : "Hey, uhm I know im not really the best with my people skills but im begging you, please take care of the 5 spiders at the Questing Cave. I have a special material I need from there and those pesky spiders are always there. Kill them, so that I can atleast grab some before more come."
set gotquest2=true
echo.
echo.
pause
